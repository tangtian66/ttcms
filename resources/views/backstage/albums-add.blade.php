            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="file-manager">
                        <h5>相册标题</h5>
                        <input type="text" placeholder="请输入相册标题" name="albumtitle" class="form-control">
...
@section('myjs')
    <script>
        $('#save_data').click(function () {
            ...
            if(albumtitle.length<2){
                ...
                $.post('{{route('admin.album.add')}}',formdata,function (o) {
    ...
    o_ueditorupload.ready(function ()
    {
        ...
        o_ueditorupload.addListener('beforeInsertImage', function (t,result)
        {
            ...
            for(var i in result){
                $("#imgs_count").append('  <div class="file-box"  onclick="del(this)">\n' +
                    '                        <div class="file">\n' +
